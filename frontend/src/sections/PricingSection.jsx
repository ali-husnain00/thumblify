...
export default function PricingSection() {
    return (
        <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Pricing" text2="Plans for every channel" text3="Pick the generation volume you need—upgrade or downgrade as your upload schedule changes." />
