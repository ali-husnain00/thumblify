  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Thumblify turns your video topic into scroll-stopping cover art—clear
          faces, bold text, and contrast that reads in the feed before anyone
          hits play.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Iterate faster, stay on-brand
            </h3>
            <p className="text-slate-300 mt-2">
              Generate variations in seconds, keep your channel look consistent,
              and ship thumbnails without a design backlog.
            </p>
            <Link
              to="/generate"
