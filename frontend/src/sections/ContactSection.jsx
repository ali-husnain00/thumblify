...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="We’re here to help" text3="Questions about billing, a feature idea, or a creator partnership? Send a message and we’ll get back to you." />
